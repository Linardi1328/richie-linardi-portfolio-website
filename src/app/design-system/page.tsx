            ...
            <div className="mt-16 grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
              ...
              <div className="max-w-xl lg:justify-self-end">
                <p className="type-body-large text-text-secondary">
                  A restrained visual foundation for professional work,
                  basketball impact, and the shared discipline connecting both.
                </p>
          ...
          <Container size="wide">
            ...
            <ResponsiveGrid className="mt-8" columns="three">
              ...
              <Card
                ...
                eyebrow="Footer"
                footer={
                  <TextLink href="/design-system">Review pattern</TextLink>
                }
                title="Content Card"
              />
            </ResponsiveGrid>
          ...
          <Container size="wide">
            ...
            <ResponsiveGrid className="mt-8" columns="three">
              ...
              <Surface>
                ...
                <p className="type-body-small mt-2 text-text-secondary">
                  Disabled state reduces opacity and removes pointer
                  interaction.
                </p>
                <div className="mt-5">
          ...
          <Container size="wide">
            ...
            <ResponsiveGrid className="mt-8" columns="two">
              <Surface className="theme-professional">
                ...
                <p className="type-body-small mt-2 text-text-secondary">
                  The animated bar becomes static when reduced motion is
                  enabled.
                </p>
