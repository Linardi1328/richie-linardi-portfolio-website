...
import { getProjectBySlug, publicProjectCatalogue } from "@/data/project-registry";
      ...
      <main className="foundation-route">
        <section className="foundation-route__hero">
          <div className="foundation-route__hero-inner">
            <p className="foundation-route__eyebrow">Project case study · {project.phase}</p>
            <h1>{project.title}</h1>
            <p className="foundation-route__lede">{project.summary}</p>
            <a className="foundation-route__primary-link" href={project.repositoryUrl} rel="noreferrer" target="_blank">
              Open source repository <span aria-hidden="true">↗</span>
            </a>
          </div>
        </section>

        <section className="foundation-route__sections" aria-label={`${project.title} case study foundation`}>
          <article className="foundation-route__section">
            <div className="foundation-route__section-index" aria-hidden="true">01</div>
            <div>
          ...
          <article className="foundation-route__section">
            <div className="foundation-route__section-index" aria-hidden="true">02</div>
            <div>
          ...
          <article className="foundation-route__section">
            <div className="foundation-route__section-index" aria-hidden="true">03</div>
            <div>
          ...
          <article className="foundation-route__section">
            <div className="foundation-route__section-index" aria-hidden="true">04</div>
            <div>
              <p className="foundation-route__eyebrow">Next interface pass</p>
              <h2>Architecture, workflow, decisions, limitations, roadmap.</h2>
              <div>
                <p>
                  The detailed visual case-study modules will be filled after the preview review. The route, evidence model, truth boundary, and responsive composition are already in place.
                </p>
                <Link className="foundation-route__primary-link" href="/projects">
